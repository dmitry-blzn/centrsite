    ...
    <div className='dates'>
        <div className="dates__column">
            ...
            <div className="dates__column-cards">
                <Link to={'/news'}><BigEventCard className='eventcard' image={require('../../images/eventpage/winners.png')} date='17.05.2023' title='Событие' width='489px' height='266px' text='Студенты НИУ «БелГУ» – победители историко-патриотической игры «Забвению не подлежит!»'/></Link>
            ...
            {!show ?
                <div className="dates__column-button">
                    <button className='dates__column-button-b' onClick={() => setShow(true)}>Показать ещё</button>
                </div>
                :
                <div className="dates__column-button">
                    <button className='dates__column-button-b' onClick={() => setShow(false)}>Скрыть</button>
                </div>
            }
